...
$array2 = array();
$array2['passed'] = $array['6'] + $array['7'] + $array['8'] + $array['9'] + $array['10'];
$array2['failed'] = $array['5'];
$array2['ungraded'] = $array['Ungraded'];

$data = array();
// Structure data for google visualization API
$data['cols'] = array(
    array('id' => '1', 'label' => 'Status', 'type' => 'string'),
    array('id' => '2', 'label' => 'Percent', 'type' => 'number'),
);
